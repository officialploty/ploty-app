// approve-layout
// Staff-only. Flips a pending layout to approved and notifies the submitter.
...
export default {
  fetch: withSupabase({ auth: "user" }, async (req, ctx) => {
    ...
    await sendSms(submitter?.phone ?? null, `Your layout "${layout.locality}" has been approved and is now live on Ploty.`);
